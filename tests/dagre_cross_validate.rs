...
use d2_little::dagre::graph::{Graph, GraphOptions};
use d2_little::dagre::layout::layout;
use d2_little::dagre::layout::types::*;
...
fn load_reference() -> Vec<TestCase> {
    let data = include_str!("fixtures/dagre_cross_validate/reference_data.json");
